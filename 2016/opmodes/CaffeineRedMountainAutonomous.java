...
@Autonomous(name="RED Mountain", group = "AutoTeam25")
public class CaffeineRedMountainAutonomous extends OpMode {
    ...
    public void loop () {
        ...
        switch(state) {
            ...
            case 16:
                ...
                break;
            // Case 17 - 20: Forward 8 inches (slow speed).
            case 17:
                leftTread.setPower(0.5);
                rightTread.setPower(0.5);
                if (Math.abs(leftTread.getCurrentPosition()) >= (8 * TICKS_PER_INCH)) {
                    state = 18;
                }
                break;
            case 18:
