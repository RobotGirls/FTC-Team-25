...
public class GlyphAutonomousPathUtility {
    ...
    public GlyphAutonomousPathUtility()
    {
        ...
        paths[StartStone.RED_NEAR.ordinal()][TargetColumn.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 25, GlyphConstants.STRAIGHT_SPEED);
        ...
        paths[StartStone.RED_NEAR.ordinal()][TargetColumn.CENTER.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 32, GlyphConstants.STRAIGHT_SPEED);
        ...
        paths[StartStone.RED_NEAR.ordinal()][TargetColumn.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 42, GlyphConstants.STRAIGHT_SPEED);
        ...
        paths[StartStone.RED_FAR.ordinal()][TargetColumn.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 2, -GlyphConstants.SIDEWAYS_SPEED);
        ...
        paths[StartStone.RED_FAR.ordinal()][TargetColumn.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 6, -GlyphConstants.SIDEWAYS_SPEED);
        ...
        //BLUE NEAR RIGHT  --------------------------------------------------------------------------------------------------------------------------------------------------------------
        paths[StartStone.BLUE_NEAR.ordinal()][TargetColumn.RIGHT.ordinal()] = new DeadReckonPath();
        paths[StartStone.BLUE_NEAR.ordinal()][TargetColumn.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 7, -GlyphConstants.STRAIGHT_SPEED);
        ...
        //BLUE NEAR LEFT  -------------------------------------------------------------------------------------------------------------------------------------------------------------
        paths[StartStone.BLUE_NEAR.ordinal()][TargetColumn.LEFT.ordinal()] = new DeadReckonPath();
        paths[StartStone.BLUE_NEAR.ordinal()][TargetColumn.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.STRAIGHT, 11, -GlyphConstants.STRAIGHT_SPEED);
        ...
        paths[StartStone.BLUE_FAR.ordinal()][TargetColumn.RIGHT.ordinal()].addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 2.5, -GlyphConstants.SIDEWAYS_SPEED);
        ...
        paths[StartStone.BLUE_FAR.ordinal()][TargetColumn.LEFT.ordinal()].addSegment(DeadReckonPath.SegmentType.SIDEWAYS, 2.25, GlyphConstants.SIDEWAYS_SPEED);
