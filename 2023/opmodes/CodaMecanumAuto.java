...
import team25core.CindyssMecanumFourWheelDrivetrain;
...
public class CodaMecanumAuto extends StandardFourMotorRobot {
    ...
    private CindyssMecanumFourWheelDrivetrain drivetrain;


    @Override
    public void init() {
        super.init(); // taking parent's init (hardware mapping)
        //instantiating the CindyssMecanumFourWheelDrivetrain class
        drivetrain = CindyssMecanumFourWheelDrivetrain(frontRight, backRight, frontLeft, backLeft);
