...
@TeleOp(name = "LM2TELEOP2wColorSensor1")
//@Disabled
...
//    private ColorSensor colorSensor;
    ...
    private static final int GREEN_LOW_LIFT_POSITION = 3150;
    private static final int RED_MED_LIFT_POSITION = 4830;
    private static final int BLUE_HIGH_LIFT_POSITION = 5500;
    ...
    public void init() {
        ...
        liftColorSensor = hardwareMap.get(RevColorSensorV3.class, "liftColorSensor");
       ...
       scheme = new TwoStickMechanumControlScheme(gamepad1);
        ...
        rgbColorSensorMotorTask = new RGBColorSensorMotorTask(this, liftColorSensor, linearLift);
...
//                      case BUTTON_X_DOWN:
//                        locationTlm.setValue( "BLUE: " + liftColorSensor.blue() );
//                        break;
//                    case BUTTON_Y_DOWN:
//                        locationTlm.setValue( "RED: " + liftColorSensor.red() );
//                        break;
//                    case BUTTON_B_DOWN:
//                        locationTlm.setValue( "GREEN: " + liftColorSensor.green() );
//                        break;
//
//
//                }
...
//        });
        ...
        colorSensorTask = new RGBColorSensorTask(this, liftColorSensor) {
            public void handleEvent(RobotEvent e) {
...
//                        linearLift.setPower(0);
                    ...
                    case BUTTON_A_DOWN:
                        linearLift.setTargetPosition(GREEN_LOW_LIFT_POSITION);
                        linearLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        linearLift.setPower(0.75);
                        while (linearLift.isBusy()) {}
                        linearLift.setPower(0);
                        linearLift.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
                        break;
                    case BUTTON_B_DOWN:
                        linearLift.setTargetPosition(RED_MED_LIFT_POSITION);
                        linearLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        linearLift.setPower(0.75);
                        while (linearLift.isBusy()) {}
                        linearLift.setPower(0);
                        ...
                        break;
                    case BUTTON_Y_DOWN:
                        linearLift.setTargetPosition(BLUE_HIGH_LIFT_POSITION);
                        linearLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                        linearLift.setPower(0.75);
                        while (linearLift.isBusy()) {}
                        linearLift.setPower(0);
