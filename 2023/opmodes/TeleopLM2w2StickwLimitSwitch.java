...
import team25core.LimitSwitchGenericTask;

@TeleOp(name = "LM2TELEOP")
//@Disabled
public class TeleopLM2w2StickwLimitSwitch extends StandardFourMotorRobot {
    ...
    private Telemetry.Item umbrellaSwitchTlm;
...
//        distanceSensorCriteria = DistanceSensorCriteria(alignerDistanceSensor,2);
       ...
       scheme = new TwoStickMechanumControlScheme(gamepad1);
        ...
        umbrellaSwitchTlm = telemetry.addData("Umbrella Switch", "unknown");
    ...
    public void start() {
       ...
       // addTask(turrtTask);
        ...
        this.addTask(new LimitSwitchGenericTask(this, umbrellaLimitSwitch, telemetry) {
            public void handleEvent(RobotEvent e) {
                LimitSwitchEvent gamepadEvent = (LimitSwitchEvent) e;
                locationTlm.setValue("in limit umbrella handler");
                switch (gamepadEvent.kind) {
                    case OPEN:
                        break;
                    case CLOSED:
...
//                        break;
                    case BUTTON_Y_DOWN:
                        //distance sensor detects cone and lowers lift
                        if (umbrellaLimitSwitch.getState() == false){
                        ...
                        break;
                    case BUTTON_A_DOWN:
//                        if(alignerDistanceSensor.getDistance(DistanceUnit.CM) == 2.5){
//                            linearLift.setPower(-1);
//                        }
//                        else{
//                            linearLift.setPower(0);
//                        }
                        //if touch sensor is pressed, lift movement breaks and umbrella locks in cone
//                        if(linearTouchSensor.isPressed()){
//                            locationTlm.setValue( "Touch Sensor: " + linearTouchSensor.isPressed());
//                            linearLift.setPower(0);
                            umbrella.setPosition(0.55);
//                        else{
//                            locationTlm.setValue( "Touch Sensor: " + linearTouchSensor.isPressed());
