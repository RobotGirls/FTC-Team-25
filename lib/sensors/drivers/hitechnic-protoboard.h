 ...
 */
/*
 * $Id: hitechnic-protoboard.h 112 2012-10-04 17:44:38Z xander $
 */
...
int HTPBgetIOCfg(tSensors link) {
  memset(HTPB_I2CRequest, 0, sizeof(tByteArray));
  ...
  if (!writeI2C(link, HTPB_I2CRequest, HTPB_I2CReply, 1)) {
    return -1;
  } else {
    return HTPB_I2CReply[0];
  }
}
